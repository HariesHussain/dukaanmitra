    ...
    <div className="min-h-screen bg-[#070a13] flex flex-col justify-center items-center px-4 relative overflow-hidden select-none">
      ...
      >
        <div className="mb-8">
          ...
          <p className="text-xs text-gray-400 mt-1.5">Sign in to manage your automated shop database</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          >
            <span>{loading ? 'Entering Sandbox...' : 'Sign In'}</span>
